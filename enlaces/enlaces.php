...
<?php require("../header.php");?>
	...
	<div id="izda-b">
			<div class="content">
				<div class="box-blue">
			    	...
			    	<a href="#entidades"><img src="images/enlaces_btn_03.gif" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('entidadesimg','','images/enlaces_btn_over_03.gif',1)" width="223" height="105" border="0" id="entidadesimg" /></a>
			        <a href="#organismos"><img src="images/enlaces_btn_06.gif" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('organismosimg','','images/enlaces_btn_over_06.gif',1)"  width="223" height="105" alt="Enlaces Btn 06" id="organismosimg"></a>
			        <a href="#boletines"><img src="images/enlaces_btn_08.gif" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('boletinesimg','','images/enlaces_btn_over_08.gif',1)"  width="223" height="105" alt="Enlaces Btn 08" id="boletinesimg"></a>
			        <a href="#otros"><img src="images/enlaces_btn_10.gif" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('otrosimg','','images/enlaces_btn_over_10.gif',1)"  width="223" height="105" alt="Enlaces Btn 10" id="otrosimg"></a>
				</div>
			</div>
	</div>
	<a name="top"></a>
	<div id="dcha-b"class="box-red">	
				<div id="entidades">
					<h2 class="section"><b><a name="a-entidades">Entidades colaboradoras</a></b></h2><br/>
					<div class="cuadrito">
						...
						<a href="https://www.bancsabadell.com" target="_blank"><p>BancoSabadell (en castellano)</p></a>
					</div>
					<div class="cuadrito">
					...
					<a href="#top" class="link_arriba">Ir a arriba</a>
				</div>
	</div>
	<div id="dcha-b"class="box-red">	
		<div id="organismos">
			<h2 class="section"><b><a name="a-organismos">Organismos Oficiales</a></b></h2><br/>
			<div class="cuadrito">
	...
	<div id="dcha-b"class="box-red">	
		<div id="boletines">
			<h2 class="section"><b><a name="a-boletines">Boletines oficiales</a></b></h2><br/>
			<div class="cuadrito">
		...
		<div id="dcha-b"class="box-red">
			<div id="otros">
				<h2 class="section"><b><a name="a-otros">Otros enlaces de interés</a></b></h2>
