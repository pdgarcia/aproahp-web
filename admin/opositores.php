...
<?php
	...
	echo "<div id=opoconfig><h3>Configuración de la Pagina Opositores</h3>Cuando se escriba una nueva entrada, se enviara un mail al usuario <strong>".$row["USR_Displayname"]."</strong>, para cambiarlo seleccione el usuario de la siguiente lista:<br>";
