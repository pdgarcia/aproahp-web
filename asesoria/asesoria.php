...
Este servicio puede utilizarse a partir del 1 de junio de 2005 y tiene las siguientes características:</p>
		...
		<ul>
		<li>Asesoramiento y consultoría totalmente gratuita para todos los asociados.</li>
		<li>Descuentos importantes en otras actuaciones de tipo individual (contenciosos, recursos...)</li>
		</ul>	
		<p>Para utilizar este servicio se podrá recurrir a cualquiera de los siguientes datos de contacto identificándose como asociado de APROAHP:</p>
	...
	<div id="dcha-a">
		<div class="box-blue">
			...
			<div class="content">
				<p>D. JORGE APARICIO MARBÁN<br/>
					(Aparicio & Asociados Abogados)</p>
